"""
################################################################################
  riffmetrics.riffmetrics.py
################################################################################

The riffmetrics module processes raw riffdata into metrics and reads and writes
those metrics from the riffmetrics database
...
default_port = 27017
default_db_name = 'riffmetrics'

# or
# mongo_uri: mongodb://localhost:27017/riffmetrics
...
class RiffMetrics:
    """
    An instance of RiffMetrics is created with the MongoDb
    domain, port and db name of the riffmetrics database to
    be queried.
